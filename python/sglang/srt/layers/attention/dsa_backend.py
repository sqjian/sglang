...
def _validate_dsa_dcp_launch(
    *,
    ...
    """Reject DSA-DCP combinations outside the validated H20 first phase."""
    if not dcp_enabled:
        return
    ...
    if device_capability[0] != 9:
        raise ValueError(
            "DSA DCP first-phase support requires SM90 (H20/Hopper); got "
            f"sm_{device_capability[0]}{device_capability[1]}."
        )
