...
pub struct ServerArgs {
    ...
    /// PD-disaggregation role. Health probes need fake bootstrap metadata on
    /// prefill and decode nodes so the Python scheduler treats them as no-op KV
    /// probes instead of invalid room-less requests.
