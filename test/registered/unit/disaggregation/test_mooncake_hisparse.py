...
class TestMooncakeHiSparseTransfer(unittest.TestCase):
    def test_hisparse_transfer_uses_only_target_kv_group(self):
        ...
        np.testing.assert_array_equal(captured["prefill_data_indices"], np.array([20, 21, 22, 23]))
        np.testing.assert_array_equal(captured["dst_data_indices"], np.array([10, 11, 12, 13]))
