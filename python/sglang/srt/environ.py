...
class Envs:
    ...
    SGLANG_HICACHE_MOONCAKE_SKIP_WARMUP = EnvBool(False)
    SGLANG_HICACHE_MOONCAKE_WARMUP_DELAY_SECONDS = EnvFloat(0.0)
    SGLANG_HICACHE_MOONCAKE_DISABLE_STORAGE_IO = EnvBool(False)
